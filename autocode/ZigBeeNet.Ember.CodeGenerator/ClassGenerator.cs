...
namespace ZigBeeNet.Ember.CodeGenerator
{
    public abstract class ClassGenerator
    {
        ...
        //readonly string _sourceRootPath = "ZigBeeNet.Libraries.ZigBeeNet.Hardware.Ember";
            ...
            if (parameter.DisplayType != null)
            {
                switch (parameter.DisplayType.ToLower())
                {
                    case "hex":
                        ...
                        return "string.Format(\"0x{0:X" + size + "}\", _" + parameter.Name + modifier + ")";
                    case "string":
                        return "_" + parameter.Name + modifier;
                }
            }
            return "_" + parameter.Name + modifier;
        }
