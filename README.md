...
| Data Store JSON                | `ZigbeeNet.DataStore.JSON`       | [![NuGet](https://img.shields.io/nuget/v/ZigbeeNet.DataStore.JSON.svg?style=flat-square&label=nuget)](https://www.nuget.org/packages/ZigbeeNet.DataStore.JSON/)             | JSON DataStore                                  |
| Data Store MongoDb             | `ZigbeeNet.DataStore.MongoDb`    | [![NuGet](https://img.shields.io/nuget/v/ZigbeeNet.DataStore.MongoDb.svg?style=flat-square&label=nuget)](https://www.nuget.org/packages/ZigbeeNet.DataStore.MongoDb/)       | MongoDb DataStore                               |
