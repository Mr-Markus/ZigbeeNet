...
namespace ZigBeeNet.ZCL.Clusters.IASACE
{
       public class BypassResponse : ZclCommand
       {
           ...
           ///
          /// An array of Zone IDs for each zone requested to be bypassed via the Bypass command where X is equal to the value of          /// the Number of Zones field. The order of results for Zone IDs SHALL be the same as the order of Zone IDs sent in          /// the Bypass command by the IAS ACE client.           /// </summary>
