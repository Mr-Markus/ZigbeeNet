...
namespace ZigBeeNet.ZCL.Clusters
{
   public class ZclOTAUpgradeCluster : ZclCluster
   {
       ...
       /// </summary>
       public static ushort CLUSTER_ID = 0x0019;

       /// <summary>
       /// The ZigBee Cluster Library Cluster Name
       /// </summary>
       public static string CLUSTER_NAME = "OTA Upgrade";
       ...
       public static ushort ATTR_UPGRADESERVERID = 0x0000;
       ...
       public static ushort ATTR_FILEOFFSET = 0x0001;
       ...
       public static ushort ATTR_CURRENTFILEVERSION = 0x0002;
       ...
       public static ushort ATTR_CURRENTZIGBEESTACKVERSION = 0x0003;
       ...
       public static ushort ATTR_DOWNLOADEDFILEVERSION = 0x0004;
       ...
       public static ushort ATTR_DOWNLOADEDZIGBEESTACKVERSION = 0x0005;
       ...
       public static ushort ATTR_IMAGEUPGRADESTATUS = 0x0006;

       /// <summary>
       /// </summary>
       public static ushort ATTR_MANUFACTURERID = 0x0007;

       /// <summary>
       /// </summary>
       public static ushort ATTR_IMAGETYPEID = 0x0008;
       ...
       public static ushort ATTR_MINIMUMBLOCKREQUESTDELAY = 0x0009;

       /// <summary>
       /// </summary>
       public static ushort ATTR_IMAGESTAMP = 0x000A;
       ...
       /// @param payloadType {@link byte} Payload type
       /// @param queryJitter {@link byte} Query jitter
       /// @param manufacturerCode {@link ushort} Manufacturer code
       /// @param imageType {@link ushort} Image type
       /// @param newFileVersion {@link uint} New File Version
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// @param fieldControl {@link byte} Field control
       /// @param manufacturerCode {@link ushort} Manufacturer code
       /// @param imageType {@link ushort} Image type
       /// @param fileVersion {@link uint} File version
       /// @param hardwareVersion {@link ushort} Hardware version
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// @param imageType {@link ushort} Image type
       /// @param fileVersion {@link uint} File version
       /// @param fileOffset {@link uint} File offset
       /// @param maximumDataSize {@link byte} Maximum data size
       /// @param requestNodeAddress {@link IeeeAddress} Request node address
       /// @param blockRequestDelay {@link ushort} BlockRequestDelay
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// @param fileOffset {@link uint} File offset
       /// @param maximumDataSize {@link byte} Maximum data size
       /// @param pageSize {@link ushort} Page size
       /// @param responseSpacing {@link ushort} Response spacing
       /// @param requestNodeAddress {@link IeeeAddress} Request node address
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// @param imageType {@link ushort} Image type
       /// @param fileVersion {@link uint} File Version
       /// @param zigbeeStackVersion {@link ushort} Zigbee Stack Version
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// @param imageType {@link ushort} Image type
       /// @param fileVersion {@link uint} File Version
       /// @param imageSize {@link uint} Image Size
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// @param imageType {@link ushort} Image type
       /// @param fileVersion {@link uint} File Version
       /// @param currentTime {@link uint} Current Time
       /// @param upgradeTime {@link uint} Upgrade Time
       /// @return the Task<CommandResult> command result Task
       /// </summary>
