...
namespace ZigBeeNet.ZCL.Clusters
{
   public class ZclScenesCluster : ZclCluster
   {
       ...
       * The Add Scene command shall be addressed to a single device (not a group).       </summary>
       <param name= groupID {@link ushort} Group ID</param>
       <param name= sceneID {@link byte} Scene ID</param>
       <param name= transitionTime {@link ushort} Transition time</param>
       <param name= sceneName {@link string} Scene Name</param>
       <param name= extensionFieldSets {@link List<ExtensionFieldSet>} Extension field sets</param>
       ...
       * The View Scene command shall be addressed to a single device (not a group).       </summary>
       <param name= groupID {@link ushort} Group ID</param>
       <param name= sceneID {@link byte} Scene ID</param>
       <returns the Task<CommandResult> command result Task
       </returns>
       ...
       * The Remove All Scenes may be addressed to a single device or to a group.       </summary>
       <param name= groupID {@link ushort} Group ID</param>
       <param name= sceneID {@link byte} Scene ID</param>
       <returns the Task<CommandResult> command result Task
       </returns>
       ...
       * The Store Scene command may be addressed to a single device or to a group.       </summary>
       <param name= groupID {@link ushort} Group ID</param>
       <param name= sceneID {@link byte} Scene ID</param>
       <returns the Task<CommandResult> command result Task
       </returns>
       ...
       * The Recall Scene command may be addressed to a single device or to a group.       </summary>
       <param name= groupID {@link ushort} Group ID</param>
       <param name= sceneID {@link byte} Scene ID</param>
       <returns the Task<CommandResult> command result Task
       </returns>
       ...
       * The Get Scene Membership command can be used to find an unused scene       * number within the group when no commissioning tool is in the network, or for a       * commissioning tool to get used scenes for a group on a single device or on all       * devices in the group.       </summary>
       <param name= groupID {@link ushort} Group ID</param>
       <returns the Task<CommandResult> command result Task
       </returns>
       ...
       <param name= groupID {@link ushort} Group ID</param>
       <param name= sceneCount {@link byte} Scene count</param>
       <param name= sceneList {@link List<byte>} Scene list</param>
       <returns the Task<CommandResult> command result Task
       </returns>
