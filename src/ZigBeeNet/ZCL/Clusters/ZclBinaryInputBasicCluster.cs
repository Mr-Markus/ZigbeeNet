...
namespace ZigBeeNet.ZCL.Clusters
{
   public class ZclBinaryInputBasicCluster : ZclCluster
   {
       ...
       /// <summary>
        ...
        /// PresentValue attribute. If OutOfService is TRUE, then the Polarity attribute SHALL have no effect on the PresentValue attribute.       /// </summary>
       ...
       /// <summary>
        /// The ApplicationType attribute is an unsigned 32 bit integer that indicates the specific        /// application usage for this cluster. (Note: This attribute has no BACnet equivalent).        /// ApplicationType is subdivided into Group, Type and an Index number, as follows.        /// <p>        /// Group = Bits 24-31 An indication of the cluster this attribute is part of.        /// <p>        /// Type = Bits 16-23 For Analog clusters, the physical quantity that the Present Value attribute        /// of the cluster represents. For Binary and Multistate clusters, the application usage domain.        /// <p>        /// Index = Bits 0-15The specific application usage of the cluster.       /// </summary>
       ...
       ///
       /// @param activeText the string attribute value to be set
       ...
       /// The implementation of this attribute by a device is OPTIONAL
       ///
       /// @param inactiveText the string attribute value to be set
       /// @return the Task<CommandResult> command result Task
       /// </summary>
       ...
       /// The implementation of this attribute by a device is MANDATORY
       ///
       /// @param presentValue the bool attribute value to be set
       /// @return the Task<CommandResult> command result Task
       /// </summary>
