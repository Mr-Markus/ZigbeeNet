    ...
    public static class ZclDataType
    {
        ...
        static ZclDataType()
        {
            _dataTypeMapping = new Dictionary<string, DataTypeMap>
            {
                ...
                { "N_X_NWK_ADDRESS", new DataTypeMap("List<int>", 0, 0, false) },
                { "CLUSTERID", new DataTypeMap("int", 0, 0, false) },
                { "N_X_CLUSTERID", new DataTypeMap("List<int>", 0, 0, false) },
                { "ENDPOINT", new DataTypeMap("int", 0, 0, false) },
                { "N_X_ENDPOINT", new DataTypeMap("List<int>", 0, 0, false) },
                ...
                { "N_X_UNSIGNED_16_BIT_INTEGER", new DataTypeMap("List<int>", 0, 0, false) },
                { "UNSIGNED_8_BIT_INTEGER_ARRAY", new DataTypeMap("int[]", 0, 0, false) },
                { "X_UNSIGNED_8_BIT_INTEGER", new DataTypeMap("List<int>", 0, 0, false) },
                { "N_X_UNSIGNED_8_BIT_INTEGER", new DataTypeMap("List<int>", 0, 0, false) },
                { "N_X_ATTRIBUTE_IDENTIFIER", new DataTypeMap("List<int>", 0, 0, false) },
                ...
                { "SIGNED_8_BIT_INTEGER", new DataTypeMap("int", 0x28, 1, true, 0x80) },
                { "SIGNED_16_BIT_INTEGER", new DataTypeMap("int", 0x29, 2, true, 0x8000) },
                { "SIGNED_32_BIT_INTEGER", new DataTypeMap("int", 0x2b, 4, true, 0x80000000) },
                { "UNSIGNED_8_BIT_INTEGER", new DataTypeMap("int", 0x20, 1, true, 0xff) },
                { "UNSIGNED_16_BIT_INTEGER", new DataTypeMap("int", 0x21, 2, true, 0xffff) },
                { "UNSIGNED_24_BIT_INTEGER", new DataTypeMap("int", 0x22, 3, true, 0xffffff) },
                { "UNSIGNED_32_BIT_INTEGER", new DataTypeMap("int", 0x23, 4, true, 0xffffffff) },
                { "UNSIGNED_40_BIT_INTEGER", new DataTypeMap("int", 0x24, 4, true, 0) },// 0xffffffffff));
                { "UNSIGNED_48_BIT_INTEGER", new DataTypeMap("int", 0x25, 6, true, 0) },// 0xffffffffffff));
                { "BITMAP_8_BIT", new DataTypeMap("int", 0x18, 1, false) },
                { "BITMAP_16_BIT", new DataTypeMap("int", 0x19, 2, false) },
                { "BITMAP_24_BIT", new DataTypeMap("int", 0x1a, 3, false) },
                { "BITMAP_32_BIT", new DataTypeMap("int", 0x1b, 4, false) },
                { "ENUMERATION_16_BIT", new DataTypeMap("int", 0x31, 2, false, 0xffff) },
                { "ENUMERATION_8_BIT", new DataTypeMap("int", 0x30, 1, false, 0xff) },
                { "DATA_8_BIT", new DataTypeMap("int", 0x08, 1, false) },
