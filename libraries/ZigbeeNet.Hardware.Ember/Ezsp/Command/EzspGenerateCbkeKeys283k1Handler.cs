...
namespace ZigBeeNet.Hardware.Ember.Ezsp.Command
{
    ...
    /// <summary>
    /// Class to implement the Ember EZSP command " generateCbkeKeys283k1Handler ".
    ...
    /// </summary>
    public class EzspGenerateCbkeKeys283k1Handler : EzspFrameResponse
    {
        
        public const int FRAME_ID = 233;
        ...
        /// </summary>
        private EmberPublicKey283k1Data _ephemeralPublicKey;
        
        public EzspGenerateCbkeKeys283k1Handler(int[] inputBuffer) : 
                base(inputBuffer)
        {
            _status = deserializer.DeserializeEmberStatus();
            _ephemeralPublicKey = deserializer.DeserializeEmberPublicKey283k1Data();
        }
        ...
        /// <summary>
        /// The ephemeralPublicKey to set as <see cref="EmberPublicKey283k1Data"/> </summary>
        ...
        /// <summary>
        ///  The generated ephemeral public key.
        /// Return the ephemeralPublicKey as <see cref="EmberPublicKey283k1Data"/>
        /// </summary>
