...
namespace ZigBeeNet.Hardware.Ember.Ezsp.Command
{
    ...
    /// <summary>
    /// Class to implement the Ember EZSP command " getTransientKeyTableEntry ".
    /// Gets the transient link key at the index specified in the transient key table.
    /// This class provides methods for processing EZSP commands.
    /// </summary>
    public class EzspGetTransientKeyTableEntryResponse : EzspFrameResponse
    {
        
        public const int FRAME_ID = 109;
