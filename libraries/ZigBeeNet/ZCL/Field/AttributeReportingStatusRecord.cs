...
namespace ZigBeeNet.ZCL.Field
{
    ...
    /// <summary>
    /// Attribute Reporting Status Record field. This is reported in the {@link ReadReportingConfigurationResponse}
    /// command.
    /// <p>
    /// <b>minInterval</b>:
    ...
    ///
    /// </summary>
    public class AttributeReportingStatusRecord : IZclListItemField
    {
        /// <summary>
        /// The status
        /// <p>
        ...
        /// set for the attribute on the server (or client) cluster.
        /// </summary>
        private ushort TimeoutPeriod { get; set; }
