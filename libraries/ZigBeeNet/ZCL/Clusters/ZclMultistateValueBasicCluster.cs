...
namespace ZigBeeNet.ZCL.Clusters
{
    ...
    public class ZclMultistateValueBasicCluster : ZclCluster
    {
        ...
        protected override Dictionary<ushort, ZclAttribute> InitializeServerAttributes()
        {
            ...
            attributeMap.Add(ATTR_STATETEXT, new ZclAttribute(this, ATTR_STATETEXT, "State Text", DataType.CHARACTER_STRING, false, true, true, false));
            ...
            attributeMap.Add(ATTR_NUMBEROFSTATES, new ZclAttribute(this, ATTR_NUMBEROFSTATES, "Number Of States", DataType.UNSIGNED_16_BIT_INTEGER, true, true, true, false));
            ...
            attributeMap.Add(ATTR_PRESENTVALUE, new ZclAttribute(this, ATTR_PRESENTVALUE, "Present Value", DataType.UNSIGNED_16_BIT_INTEGER, true, true, true, false));
            ...
            attributeMap.Add(ATTR_RELINQUISHDEFAULT, new ZclAttribute(this, ATTR_RELINQUISHDEFAULT, "Relinquish Default", DataType.UNSIGNED_16_BIT_INTEGER, false, true, true, false));
            attributeMap.Add(ATTR_STATUSFLAGS, new ZclAttribute(this, ATTR_STATUSFLAGS, "Status Flags", DataType.BITMAP_8_BIT, true, true, false, false));
