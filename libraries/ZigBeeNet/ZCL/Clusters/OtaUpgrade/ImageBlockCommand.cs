...
namespace ZigBeeNet.ZCL.Clusters.OtaUpgrade
{
    ...
    public class ImageBlockCommand : ZclCommand
    {
        ...
        internal override void Serialize(ZclFieldSerializer serializer)
        {
            ...
            {
                serializer.Serialize(BlockRequestDelay, DataType.UNSIGNED_16_BIT_INTEGER);
            }
        }
        ...
        internal override void Deserialize(ZclFieldDeserializer deserializer)
        {
            ...
            if ((FieldControl & 0x02) != 0)
            {
                BlockRequestDelay = deserializer.Deserialize<ushort>(DataType.UNSIGNED_16_BIT_INTEGER);
            }
        }
