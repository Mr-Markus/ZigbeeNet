...
namespace ZigBeeNet.ZCL.Clusters.General
{
    ...
    public class WriteAttributesResponse : ZclCommand
    {
        ...
        {
            serializer.Serialize(Records, DataType.N_X_WRITE_ATTRIBUTE_STATUS_RECORD);
        }

        internal override void Deserialize(ZclFieldDeserializer deserializer)
        {
            Records = deserializer.Deserialize<List<WriteAttributeStatusRecord>>(DataType.N_X_WRITE_ATTRIBUTE_STATUS_RECORD);
        }
