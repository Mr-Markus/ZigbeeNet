...
namespace ZigBeeNet.ZCL.Clusters.GreenPower
{
    ...
    public class GpProxyTableResponse : ZclCommand
    {
        ...
        internal override void Serialize(ZclFieldSerializer serializer)
        {
            ...
            serializer.Serialize(TotalNumberOfNonEmptyProxyTableEntries, DataType.UNSIGNED_8_BIT_INTEGER);
            serializer.Serialize(StartIndex, DataType.UNSIGNED_8_BIT_INTEGER);
            serializer.Serialize(EntriesCount, DataType.UNSIGNED_8_BIT_INTEGER);
            serializer.Serialize(ProxyTableEntries, DataType.UNSIGNED_8_BIT_INTEGER);
        }

        internal override void Deserialize(ZclFieldDeserializer deserializer)
        {
            Status = deserializer.Deserialize<byte>(DataType.ENUMERATION_8_BIT);
            TotalNumberOfNonEmptyProxyTableEntries = deserializer.Deserialize<byte>(DataType.UNSIGNED_8_BIT_INTEGER);
            StartIndex = deserializer.Deserialize<byte>(DataType.UNSIGNED_8_BIT_INTEGER);
            EntriesCount = deserializer.Deserialize<byte>(DataType.UNSIGNED_8_BIT_INTEGER);
            ProxyTableEntries = deserializer.Deserialize<byte>(DataType.UNSIGNED_8_BIT_INTEGER);
        }
