...
namespace ZigBeeNet.ZCL.Clusters.KeyEstablishment
{
    ...
    public class InitiateKeyEstablishmentResponse : ZclCommand
    {
        ...
        {
            serializer.Serialize(RequestedKeyEstablishmentSuite, DataType.BITMAP_16_BIT);
        ...
        {
            RequestedKeyEstablishmentSuite = deserializer.Deserialize<ushort>(DataType.BITMAP_16_BIT);
