...
namespace ZigBeeNet.ZCL.Clusters.Price
{
    ...
    ///
    /// Cluster: Price. Command ID 0x04 is sent TO the server.
    ...
    /// </summary>
    public class GetConversionFactorCommand : ZclCommand
    {
        /// <summary>
        ...
        /// ordered StartTime.
        /// Min. Issuer Event ID Field A 32-bit integer representing the minimum Issuer Event
        /// ID of values to be returned by the corresponding PublishCalorificValue command. A
        /// value of 0xFFFFFFFF means not specified; the server shall return values
        ...
        /// of 0 would indicate all available PublishConversionFactor commands shall be
        /// returned.
        /// </summary>
