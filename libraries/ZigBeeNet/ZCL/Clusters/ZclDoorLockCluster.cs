...
namespace ZigBeeNet.ZCL.Clusters
{
    ...
    public class ZclDoorLockCluster : ZclCluster
    {
        ...
        protected override Dictionary<ushort, ZclAttribute> InitializeServerAttributes()
        {
            ...
            attributeMap.Add(ATTR_LOCKSTATE, new ZclAttribute(this, ATTR_LOCKSTATE, "Lock State", DataType.ENUMERATION_8_BIT, true, true, false, false));
            attributeMap.Add(ATTR_LOCKTYPE, new ZclAttribute(this, ATTR_LOCKTYPE, "Lock Type", DataType.ENUMERATION_8_BIT, true, true, false, false));
            attributeMap.Add(ATTR_ACTUATORENABLED, new ZclAttribute(this, ATTR_ACTUATORENABLED, "Actuator Enabled", DataType.BOOLEAN, true, true, false, false));
            attributeMap.Add(ATTR_DOORSTATE, new ZclAttribute(this, ATTR_DOORSTATE, "Door State", DataType.ENUMERATION_8_BIT, true, true, false, false));
            attributeMap.Add(ATTR_DOOROPENEVENTS, new ZclAttribute(this, ATTR_DOOROPENEVENTS, "Door Open Events", DataType.UNSIGNED_32_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_DOORCLOSEDEVENTS, new ZclAttribute(this, ATTR_DOORCLOSEDEVENTS, "Door Closed Events", DataType.UNSIGNED_32_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_OPENPERIOD, new ZclAttribute(this, ATTR_OPENPERIOD, "Open Period", DataType.UNSIGNED_16_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_NUMLOCKRECORDSSUPPORTED, new ZclAttribute(this, ATTR_NUMLOCKRECORDSSUPPORTED, "Num Lock Records Supported", DataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_NUMTOTALUSERSSUPPORTED, new ZclAttribute(this, ATTR_NUMTOTALUSERSSUPPORTED, "Num Total Users Supported", DataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_NUMPINUSERSSUPPORTED, new ZclAttribute(this, ATTR_NUMPINUSERSSUPPORTED, "Num PIN Users Supported", DataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_NUMRFIDUSERSSUPPORTED, new ZclAttribute(this, ATTR_NUMRFIDUSERSSUPPORTED, "Num RFID Users Supported", DataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_NUMWEEKDAYSCHEDULESSUPPORTEDPERUSER, new ZclAttribute(this, ATTR_NUMWEEKDAYSCHEDULESSUPPORTEDPERUSER, "Num Weekday Schedules Supported Per User", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_NUMYEARDAYSCHEDULESSUPPORTEDPERUSER, new ZclAttribute(this, ATTR_NUMYEARDAYSCHEDULESSUPPORTEDPERUSER, "Num Yearday Schedules Supported Per User", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_NUMHOLIDAYSCHEDULESSUPPORTEDPERUSER, new ZclAttribute(this, ATTR_NUMHOLIDAYSCHEDULESSUPPORTEDPERUSER, "Num Holiday Schedules Supported Per User", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_MAXPINLENGTH, new ZclAttribute(this, ATTR_MAXPINLENGTH, "Max PIN Length", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_MINPINLENGTH, new ZclAttribute(this, ATTR_MINPINLENGTH, "Min PIN Length", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_MAXRFIDCODELENGTH, new ZclAttribute(this, ATTR_MAXRFIDCODELENGTH, "Max RFID Code Length", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_MINRFIDCODELENGTH, new ZclAttribute(this, ATTR_MINRFIDCODELENGTH, "Min RFID Code Length", DataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_ENABLELOGGING, new ZclAttribute(this, ATTR_ENABLELOGGING, "Enable Logging", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_LANGUAGE, new ZclAttribute(this, ATTR_LANGUAGE, "Language", DataType.CHARACTER_STRING, false, true, true, true));
            attributeMap.Add(ATTR_LEDSETTINGS, new ZclAttribute(this, ATTR_LEDSETTINGS, "LED Settings", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_AUTORELOCKTIME, new ZclAttribute(this, ATTR_AUTORELOCKTIME, "Auto Relock Time", DataType.UNSIGNED_32_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_SOUNDVOLUME, new ZclAttribute(this, ATTR_SOUNDVOLUME, "Sound Volume", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_OPERATINGMODE, new ZclAttribute(this, ATTR_OPERATINGMODE, "Operating Mode", DataType.ENUMERATION_8_BIT, false, true, true, true));
            attributeMap.Add(ATTR_SUPPORTEDOPERATINGMODES, new ZclAttribute(this, ATTR_SUPPORTEDOPERATINGMODES, "Supported Operating Modes", DataType.BITMAP_16_BIT, true, true, false, false));
            attributeMap.Add(ATTR_DEFAULTCONFIGURATIONREGISTER, new ZclAttribute(this, ATTR_DEFAULTCONFIGURATIONREGISTER, "Default Configuration Register", DataType.BITMAP_16_BIT, true, true, false, false));
            attributeMap.Add(ATTR_ENABLELOCALPROGRAMMING, new ZclAttribute(this, ATTR_ENABLELOCALPROGRAMMING, "Enable Local Programming", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_ENABLEONETOUCHLOCKING, new ZclAttribute(this, ATTR_ENABLEONETOUCHLOCKING, "Enable One Touch Locking", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_ENABLEINSIDESTATUSLED, new ZclAttribute(this, ATTR_ENABLEINSIDESTATUSLED, "Enable Inside Status Led", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_ENABLEPRIVACYMODEBUTTON, new ZclAttribute(this, ATTR_ENABLEPRIVACYMODEBUTTON, "Enable Privacy Mode Button", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_WRONGCODEENTRYLIMIT, new ZclAttribute(this, ATTR_WRONGCODEENTRYLIMIT, "Wrong Code Entry Limit", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_USERCODETEMPORARYDISABLETIME, new ZclAttribute(this, ATTR_USERCODETEMPORARYDISABLETIME, "User Code Temporary Disable Time", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, true));
            attributeMap.Add(ATTR_SENDPINOVERTHEAIR, new ZclAttribute(this, ATTR_SENDPINOVERTHEAIR, "Send PIN Over The Air", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_REQUIREPINFORRFOPERATION, new ZclAttribute(this, ATTR_REQUIREPINFORRFOPERATION, "Require PIN For RF Operation", DataType.BOOLEAN, false, true, true, true));
            attributeMap.Add(ATTR_ZIGBEESECURITYLEVEL, new ZclAttribute(this, ATTR_ZIGBEESECURITYLEVEL, "ZigBee Security Level", DataType.ENUMERATION_8_BIT, true, true, false, false));
            attributeMap.Add(ATTR_ALARMMASK, new ZclAttribute(this, ATTR_ALARMMASK, "Alarm Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_KEYPADOPERATIONEVENTMASK, new ZclAttribute(this, ATTR_KEYPADOPERATIONEVENTMASK, "Keypad Operation Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_RFOPERATIONEVENTMASK, new ZclAttribute(this, ATTR_RFOPERATIONEVENTMASK, "RF Operation Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_MANUALOPERATIONEVENTMASK, new ZclAttribute(this, ATTR_MANUALOPERATIONEVENTMASK, "Manual Operation Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_RFIDOPERATIONEVENTMASK, new ZclAttribute(this, ATTR_RFIDOPERATIONEVENTMASK, "RFID Operation Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_KEYPADPROGRAMMINGEVENTMASK, new ZclAttribute(this, ATTR_KEYPADPROGRAMMINGEVENTMASK, "Keypad Programming Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_RFPROGRAMMINGEVENTMASK, new ZclAttribute(this, ATTR_RFPROGRAMMINGEVENTMASK, "RF Programming Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
            attributeMap.Add(ATTR_RFIDPROGRAMMINGEVENTMASK, new ZclAttribute(this, ATTR_RFIDPROGRAMMINGEVENTMASK, "RFID Programming Event Mask", DataType.BITMAP_16_BIT, false, true, true, true));
