...
namespace ZigBeeNet.ZCL.Clusters
{
    ...
    public class ZclThermostatCluster : ZclCluster
    {
        ...
        protected override Dictionary<ushort, ZclAttribute> InitializeServerAttributes()
        {
            ...
            attributeMap.Add(ATTR_LOCALTEMPERATURE, new ZclAttribute(this, ATTR_LOCALTEMPERATURE, "Local Temperature", DataType.SIGNED_16_BIT_INTEGER, true, true, false, true));
            attributeMap.Add(ATTR_OUTDOORTEMPERATURE, new ZclAttribute(this, ATTR_OUTDOORTEMPERATURE, "Outdoor Temperature", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_OCCUPANCY, new ZclAttribute(this, ATTR_OCCUPANCY, "Occupancy", DataType.BITMAP_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_ABSMINHEATSETPOINTLIMIT, new ZclAttribute(this, ATTR_ABSMINHEATSETPOINTLIMIT, "Abs Min Heat Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_ABSMAXHEATSETPOINTLIMIT, new ZclAttribute(this, ATTR_ABSMAXHEATSETPOINTLIMIT, "Abs Max Heat Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_ABSMINCOOLSETPOINTLIMIT, new ZclAttribute(this, ATTR_ABSMINCOOLSETPOINTLIMIT, "Abs Min Cool Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_ABSMAXCOOLSETPOINTLIMIT, new ZclAttribute(this, ATTR_ABSMAXCOOLSETPOINTLIMIT, "Abs Max Cool Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_PICOOLINGDEMAND, new ZclAttribute(this, ATTR_PICOOLINGDEMAND, "Pi Cooling Demand", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, true));
            attributeMap.Add(ATTR_PIHEATINGDEMAND, new ZclAttribute(this, ATTR_PIHEATINGDEMAND, "Pi Heating Demand", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, true));
            attributeMap.Add(ATTR_HVACSYSTEMTYPECONFIGURATION, new ZclAttribute(this, ATTR_HVACSYSTEMTYPECONFIGURATION, "Hvac System Type Configuration", DataType.BITMAP_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_LOCALTEMPERATURECALIBRATION, new ZclAttribute(this, ATTR_LOCALTEMPERATURECALIBRATION, "Local Temperature Calibration", DataType.SIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_OCCUPIEDCOOLINGSETPOINT, new ZclAttribute(this, ATTR_OCCUPIEDCOOLINGSETPOINT, "Occupied Cooling Setpoint", DataType.SIGNED_16_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_OCCUPIEDHEATINGSETPOINT, new ZclAttribute(this, ATTR_OCCUPIEDHEATINGSETPOINT, "Occupied Heating Setpoint", DataType.SIGNED_16_BIT_INTEGER, true, true, false, false));
            attributeMap.Add(ATTR_UNOCCUPIEDCOOLINGSETPOINT, new ZclAttribute(this, ATTR_UNOCCUPIEDCOOLINGSETPOINT, "Unoccupied Cooling Setpoint", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_UNOCCUPIEDHEATINGSETPOINT, new ZclAttribute(this, ATTR_UNOCCUPIEDHEATINGSETPOINT, "Unoccupied Heating Setpoint", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_MINHEATSETPOINTLIMIT, new ZclAttribute(this, ATTR_MINHEATSETPOINTLIMIT, "Min Heat Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_MAXHEATSETPOINTLIMIT, new ZclAttribute(this, ATTR_MAXHEATSETPOINTLIMIT, "Max Heat Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_MINCOOLSETPOINTLIMIT, new ZclAttribute(this, ATTR_MINCOOLSETPOINTLIMIT, "Min Cool Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_MAXCOOLSETPOINTLIMIT, new ZclAttribute(this, ATTR_MAXCOOLSETPOINTLIMIT, "Max Cool Setpoint Limit", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_MINSETPOINTDEADBAND, new ZclAttribute(this, ATTR_MINSETPOINTDEADBAND, "Min Setpoint Dead Band", DataType.SIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_REMOTESENSING, new ZclAttribute(this, ATTR_REMOTESENSING, "Remote Sensing", DataType.BITMAP_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_CONTROLSEQUENCEOFOPERATION, new ZclAttribute(this, ATTR_CONTROLSEQUENCEOFOPERATION, "Control Sequence Of Operation", DataType.ENUMERATION_8_BIT, true, true, false, false));
            attributeMap.Add(ATTR_SYSTEMMODE, new ZclAttribute(this, ATTR_SYSTEMMODE, "System Mode", DataType.ENUMERATION_8_BIT, true, true, false, false));
            attributeMap.Add(ATTR_ALARMMASK, new ZclAttribute(this, ATTR_ALARMMASK, "Alarm Mask", DataType.BITMAP_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_THERMOSTATRUNNINGMODE, new ZclAttribute(this, ATTR_THERMOSTATRUNNINGMODE, "Thermostat Running Mode", DataType.ENUMERATION_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_STARTOFWEEK, new ZclAttribute(this, ATTR_STARTOFWEEK, "Start Of Week", DataType.ENUMERATION_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_NUMEROFWEEKLYTRANSITIONS, new ZclAttribute(this, ATTR_NUMEROFWEEKLYTRANSITIONS, "Numer Of Weekly Transitions", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_NUMEROFDAILYTRANSITIONS, new ZclAttribute(this, ATTR_NUMEROFDAILYTRANSITIONS, "Numer Of Daily Transitions", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_TEMPERATURESETPOINTHOLD, new ZclAttribute(this, ATTR_TEMPERATURESETPOINTHOLD, "Temperature Setpoint Hold", DataType.ENUMERATION_8_BIT, false, true, true, false));
            attributeMap.Add(ATTR_TEMPERATURESETPOINTHOLDDURATION, new ZclAttribute(this, ATTR_TEMPERATURESETPOINTHOLDDURATION, "Temperature Setpoint Hold Duration", DataType.UNSIGNED_16_BIT_INTEGER, false, true, true, false));
            attributeMap.Add(ATTR_THERMOSTATPROGRAMMINGOPERATIONMODE, new ZclAttribute(this, ATTR_THERMOSTATPROGRAMMINGOPERATIONMODE, "Thermostat Programming Operation Mode", DataType.BITMAP_8_BIT, false, true, true, false));
            attributeMap.Add(ATTR_THERMOSTATRUNNINGSTATE, new ZclAttribute(this, ATTR_THERMOSTATRUNNINGSTATE, "Thermostat Running State", DataType.BITMAP_16_BIT, false, true, false, false));
            attributeMap.Add(ATTR_SETPOINTCHANGESOURCE, new ZclAttribute(this, ATTR_SETPOINTCHANGESOURCE, "Setpoint Change Source", DataType.ENUMERATION_8_BIT, false, true, false, false));
            attributeMap.Add(ATTR_SETPOINTCHANGEAMOUNT, new ZclAttribute(this, ATTR_SETPOINTCHANGEAMOUNT, "Setpoint Change Amount", DataType.UNSIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_SETPOINTCHANGESOURCETIMESTAMP, new ZclAttribute(this, ATTR_SETPOINTCHANGESOURCETIMESTAMP, "Setpoint Change Source Timestamp", DataType.UTCTIME, false, true, false, false));
            attributeMap.Add(ATTR_OCCUPIEDSETBACK, new ZclAttribute(this, ATTR_OCCUPIEDSETBACK, "Occupied Setback", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, false));
            attributeMap.Add(ATTR_OCCUPIEDSETBACKMIN, new ZclAttribute(this, ATTR_OCCUPIEDSETBACKMIN, "Occupied Setback Min", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_OCCUPIEDSETBACKMAX, new ZclAttribute(this, ATTR_OCCUPIEDSETBACKMAX, "Occupied Setback Max", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_UNOCCUPIEDSETBACK, new ZclAttribute(this, ATTR_UNOCCUPIEDSETBACK, "Unoccupied Setback", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, false));
            attributeMap.Add(ATTR_UNOCCUPIEDSETBACKMIN, new ZclAttribute(this, ATTR_UNOCCUPIEDSETBACKMIN, "Unoccupied Setback Min", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_UNOCCUPIEDSETBACKMAX, new ZclAttribute(this, ATTR_UNOCCUPIEDSETBACKMAX, "Unoccupied Setback Max", DataType.UNSIGNED_8_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_EMERGENCYHEATDELTA, new ZclAttribute(this, ATTR_EMERGENCYHEATDELTA, "Emergency Heat Delta", DataType.UNSIGNED_8_BIT_INTEGER, false, true, true, false));
            attributeMap.Add(ATTR_ACTYPE, new ZclAttribute(this, ATTR_ACTYPE, "AC Type", DataType.ENUMERATION_8_BIT, false, true, true, false));
            attributeMap.Add(ATTR_ACCAPACITY, new ZclAttribute(this, ATTR_ACCAPACITY, "AC Capacity", DataType.UNSIGNED_16_BIT_INTEGER, false, true, true, false));
            attributeMap.Add(ATTR_ACREFRIGERANTTYPE, new ZclAttribute(this, ATTR_ACREFRIGERANTTYPE, "AC Refrigerant Type", DataType.ENUMERATION_8_BIT, false, true, true, false));
            attributeMap.Add(ATTR_ACCOMPRESSORTYPE, new ZclAttribute(this, ATTR_ACCOMPRESSORTYPE, "AC Compressor Type", DataType.ENUMERATION_8_BIT, false, true, true, false));
            attributeMap.Add(ATTR_ACERRORCODE, new ZclAttribute(this, ATTR_ACERRORCODE, "AC Error Code", DataType.BITMAP_32_BIT, false, true, true, false));
            attributeMap.Add(ATTR_ACLOUVERPOSITION, new ZclAttribute(this, ATTR_ACLOUVERPOSITION, "AC Louver Position", DataType.ENUMERATION_8_BIT, false, true, true, false));
            attributeMap.Add(ATTR_ACCOILTEMPERATURE, new ZclAttribute(this, ATTR_ACCOILTEMPERATURE, "AC Coil Temperature", DataType.SIGNED_16_BIT_INTEGER, false, true, false, false));
            attributeMap.Add(ATTR_ACCAPACITYFORMAT, new ZclAttribute(this, ATTR_ACCAPACITYFORMAT, "AC Capacity Format", DataType.ENUMERATION_8_BIT, false, true, true, false));
