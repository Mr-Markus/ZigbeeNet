...
namespace ZigBeeNet.ZCL.Clusters.Prepayment
{
    ...
    public class SetMaximumCreditLimit : ZclCommand
    {
        ...
        internal override void Serialize(ZclFieldSerializer serializer)
        {
            ...
            serializer.Serialize(MaximumCreditLevel, DataType.UNSIGNED_32_BIT_INTEGER);
            serializer.Serialize(MaximumCreditPerTopUp, DataType.UNSIGNED_32_BIT_INTEGER);
        }
        ...
        internal override void Deserialize(ZclFieldDeserializer deserializer)
        {
            ...
            MaximumCreditLevel = deserializer.Deserialize<uint>(DataType.UNSIGNED_32_BIT_INTEGER);
            MaximumCreditPerTopUp = deserializer.Deserialize<uint>(DataType.UNSIGNED_32_BIT_INTEGER);
        }
