...
namespace ZigBeeNet.ZDO.Command
{
    ...
    public class MatchDescriptorResponse : ZdoResponse
    {
        ...
        internal override void Serialize(ZclFieldSerializer serializer)
        {
            ...
            serializer.Serialize(MatchList.Count, DataType.UNSIGNED_8_BIT_INTEGER);
            for (int cnt = 0; cnt < MatchList.Count; cnt++)
            {
                serializer.Serialize(MatchList[cnt], DataType.ENDPOINT);
            }
        }
        ...
        internal override void Deserialize(ZclFieldDeserializer deserializer)
        {
            ...
            byte? matchLength = (byte?) deserializer.Deserialize(DataType.UNSIGNED_8_BIT_INTEGER);
            if (matchLength != null)
            {
                for (int cnt = 0; cnt < matchLength; cnt++)
                {
                    MatchList.Add((byte) deserializer.Deserialize(DataType.ENDPOINT));
                }
            }
        }
