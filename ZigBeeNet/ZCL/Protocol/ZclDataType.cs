...
namespace ZigBeeNet.ZCL.Protocol
{
    ...
    public class ZclDataType
    {
        ...
        static ZclDataType()
        {
            ...
            _codeTypeMapping[0x81] = new ZclDataType("N X Attribute identifier", typeof(int), 0x00, false, DataType.N_X_ATTRIBUTE_IDENTIFIER);
            ...
            _codeTypeMapping[0x8c] = new ZclDataType("N X Unsigned 16-bit integer", typeof(int), 0x00, false, DataType.N_X_UNSIGNED_16_BIT_INTEGER);
            _codeTypeMapping[0x8d] = new ZclDataType("N x Unsigned 8-bit Integer", typeof(int), 0x00, false, DataType.N_X_UNSIGNED_8_BIT_INTEGER);
            ...
            _codeTypeMapping[0x91] = new ZclDataType("X Unsigned 8-bit integer", typeof(int), 0x00, false, DataType.X_UNSIGNED_8_BIT_INTEGER);
            ...
            _codeTypeMapping[0x9a] = new ZclDataType("NWK address", typeof(int), 0x00, false, DataType.NWK_ADDRESS);
            ...
            _codeTypeMapping[0xa3] = new ZclDataType("Unsigned 8 bit Integer Array", typeof(int[]), 0x00, false, DataType.UNSIGNED_8_BIT_INTEGER_ARRAY);
