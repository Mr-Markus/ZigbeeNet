...
using ZigBeeNet.Hardware.CC.Frame;
using ZigBeeNet.Hardware.CC.Implementation;
using ZigBeeNet.Hardware.CC.Network;
using ZigBeeNet.Hardware.CC.Packet;
using ZigBeeNet.Hardware.CC.Packet.AF;
...
namespace ZigBeeNet.Hardware.CC
{
