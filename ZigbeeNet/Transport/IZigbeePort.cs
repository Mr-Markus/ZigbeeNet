...
namespace ZigbeeNet.Transport
{
    ...
    public interface IZigbeePort
    {
        ...
        /// when entering a bootloader that may operate at a different speed to the coordinator.
        /// </summary>
        /// <param name="braudrate">the speed to use when opening the port</param>
        /// <param name="flowControl">the FlowControl to use when opening the port</param>
        /// <returns>true if port was opened successfully.</returns>
        bool Open(int braudrate, FlowControl flowControl);
        ...
        /// <summary>
        /// Write a data byte data to serial port. This should be non-blocking.
        /// </summary>
